      ...
      <div className="modal" role="dialog" aria-modal="true" aria-labelledby="add-modal-title">
        ...
        <form ref={formRef} onSubmit={handleSubmit}>
          <div className="modal-body gap-4">
            ...
            <div className="grid gap-2">
              <Label htmlFor="add-tags">Tags <span className="hint text-muted-foreground font-normal">(comma-separated)</span></Label>
              <Input id="add-tags" name="tags" type="text" placeholder="design, tools, inspiration" />
            </div>
            <div className="grid gap-2">
